<?php session_start();
$pageTitle = "Monthly Expense Report";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Monthly Expense Report</h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Expense Report for the Month of <?php echo date("F"); ?></h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- Questions Div -->
                                <div class="card-body">
    ...
    $currentYear = date('Y');
                                                            ...
                                                            $NR = mysqli_num_rows($QR);
                                                                 if($NR>0)
                                                                 {
                                                                     ...
                                                                     {
                                            $Serial++;
                                            $ID = $Row['idexpensetypes'];
                                            $Type = $Row['type'];

                                            //Total Fee + Received Total
                                            if(isAdmin()){
                                                
                                            $Q1 = "SELECT * FROM `expenses` WHERE idexpensetype = '$ID' AND MONTH(date) = '$currentMonth' AND YEAR(date)= '$currentYear'";                             
                                            }else{
                                                
                                            $Q1 = "SELECT * FROM `expenses` WHERE idexpensetype = '$ID' AND MONTH(date) = '$currentMonth' AND YEAR(date)= '$currentYear' AND idschool = '$userSchoolID'";
                                            }
