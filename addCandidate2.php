<?php session_start();
$pageTitle = "Add Candidate Additional Details";
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Add Candidate Additional Details</h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="date" class="form-control" id="candidatelpdate" placeholder="Learner Permit Date" name="candidatelpdate" onchange="daysCalc(this.value);" required> <small id="lpdatehelpblock" class="text-muted" style="color: red !important">
    ...
    <script>
        function daysCalc(date) {
            ...
            if (daysDiff > 42) {
                txt.innerHTML = daysDiff + " days OK";
                btn.disabled = false;
            } else {
