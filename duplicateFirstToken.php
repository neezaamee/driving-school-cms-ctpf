                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="content-header">
                                <div class="container-fluid">
                                    <div class="row mb-2">
                                        <div class="col-sm-6">
                                            <h1 class="m-0 text-dark">Duplicate First Token</h1> </div>
                                        <!-- /.col -->
                                    </div>
                                    <!-- /.row -->
                                </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="card card-primary">
                                                <div class="card-header">
                                                    <h3 class="card-title">Enter Candidate Token #</h3> </div>
                                                <!-- /.card-header -->
                                                <!-- form start -->
                                                <form class="needs-validation" role="form" method="post" action="duplicateFirstTokenPrint.php" novalidate>
                                                    <div class="card-body">
                                                        <div class="form-row">
