        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Expenses Directory</h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
                                                    ...
                                                    <table id="myTable" class="display" style="width:100%; text-align: center;" class="text-center">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                    ...
                                                                    if(!isAdmin()){
                                                                    $Q = "SELECT * FROM expenses WHERE idschool = 2";
                                                                    }else{
                                                                    ...
                                                                    $QR = mysqli_query($con,$Q);
                                                                     ...
                                                                     if($NR>0)
                                                                     {
                                                                         while($Row = mysqli_fetch_assoc($QR))
                                                                         {
                                                                             ...
                                                                             $Serial++;
                                                                             $ID = $Row['id'];
                                                                             $categoryID = $Row['idexpensetype'];
                                                                             $Category = expenseTypeByID($categoryID)->type;
                                                                             $Amount = $Row['amount'];
                                                            ...
                                                            <tr>
                                                                ...
                                                                ?>
                                                                <td>
                                                                    <a class="btn btn-outline-primary btn-sm" href="updateExpense.php?expenseID=<?php echo $ID; ?>"> Update</a>
                                                                    <button class="btn btn-outline-danger btn-sm" data-href="deleteExpense.php?expenseID=<?php echo $ID; ?>" data-toggle="modal" data-target="#confirm-delete"> Delete</button>
                                                                </td>
