        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1 class="m-0 text-dark">Sign Test (E-Exam) <span id="countdown" style="float: right"></span></h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
		...
		else if(isset($_POST['getresult']))
		{
            ...
            if($totalTrue > 6){
                ...
                echo "<center><h2 style='color: red'>You are Failed</h2></center>";
                               ...
                               mysqli_query($con,"UPDATE tests SET session_id='$currentSession',totalquestions='$totalQuestions',notanswered='$notAnswered', totalright='$totalTrue',totalwrong='$wrong',signtest='$signTestResult',finalresult='$finalResult',type='$isCommercial', testby='$loginRole-$loginUserName' WHERE candidateid='$candidateID'"); 
...
session_destroy();
echo "Please <a href=tokenfortest.php> Login and Start Again</a>";
...
$row= mysqli_fetch_row($fetchQuestionsQR);
                                ?>
                                <form name=myfm method=post action=takeExam.php>
                                    <table>
                                        <?php
