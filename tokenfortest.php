	                       ...
	                       if($fetchCandidateDataNum>0)
	                           {
		                          $candidateDataObject = mysqli_fetch_object($fetchCandidateDataQR);                                    
                                    ...
                                    $array = mysqli_fetch_assoc($fetchCandidateTestDataQR);
                                        $finalResult = $array['finalresult'];
                                        if($finalResult == "Fail"){
                                            ?><script>
    alert("Candidate Already Failed");
                                   ...
                                   ?>
<script>
    window.location.href = 'examForBike.php';
...
<?php
                               ...
                               if($_SESSION['candidateLicenseCategory'] == "M/Cycle"){
                                   ?>
<script>
    window.location.href = 'examForBikeFirst.php';
...
<?php
                                ...
                                ?>
<script>
    window.location.href = 'takeExamFirst.php';
