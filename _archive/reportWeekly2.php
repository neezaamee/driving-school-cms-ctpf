...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Weekly Report</h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Test Report for Last Week</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- Questions Div -->
                                <div class="card-body">
    ...
    if(isset($_POST['submit']))
                    ...
                    $GetStockQ = "SELECT * FROM `tests` WHERE MONTH(testdate) = '$Month'";
...
echo "<span class='btn btn-block btn-danger active'>".$signTest."</span>";} ?> </td>
                                                                <td>
                                                                    <?php if($roadTest == "Pass"){ echo "<span class='btn btn-block btn-success active'>".$roadTest."</span>"; }elseif($roadTest == "Fail"){ echo "<span class='btn btn-block btn-danger active'>".$roadTest."</span>";}else{echo "Not Attemptd";} ?> </td>
                                                                <td>
                                                                    <?php if($finalResult == "Pass"){ echo "<span class='btn btn-block btn-success active'>".finalResultt."</span>"; }elseif($finalResult == "Fail"){ echo "<span class='btn btn-block btn-danger active'>".$finalResult."</span>";}else{echo "Not Attemptd";} ?>
                                                                <td>
                                                                    <?php echo $testDate; ?>
                                                                </td>
                                                                <td>
