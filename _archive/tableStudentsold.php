                                                    ...
                                                    <table id="myTable" class="display" style="text-align: center;" class="text-center">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                    ...
                                                                    if(!isAdmin()){
                                                                    $Q = "SELECT * FROM students WHERE idschool = '$userSchoolID'";
                                                                    }else{
                                                                    ...
                                                                    $QR = mysqli_query($con,$Q);
                                                                     ...
                                                                     if($NR>0)
                                                                     {
                                                                         while($Row = mysqli_fetch_assoc($QR))
                                                                         {
                                                                             ...
                                                                             $Course = courseByID($courseID)->coursename;
                                                                             $Pickndrop = $Row['pickndrop'];
                                                                             $schoolID = $Row['idschool'];
                                                                             $School = schoolByID($schoolID)->location;
                                                                             $paidFee = admissionByRegistration($Registration)->paidfee;
                                                                             $admissionDate = admissionByRegistration($Registration)->admissiondate;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-outline-danger btn-sm" data-href="deleteStudent.php?studentID=<?php echo $ID; ?>" data-toggle="modal" data-target="#confirm-delete"> Delete</button>
                                                                </td>
