...
$questionNum=0;
/*Fetch Questions*/
$fetchQuestionsQ="select * from questions where categorylimit = 'bike' ORDER BY rand() LIMIT 10";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1 class="m-0 text-dark">Sign Test (M/Cycle) <span id="countdown" style="float: right"></span></h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
		...
		else if(isset($_POST['getresult']))
		{
            ...
            if($totalTrue > 6){
                ...
                echo "<center><h2 style='color: red'>You are Failed</h2></center>";
                               ...
                               mysqli_query($con,"UPDATE tests SET session_id='$currentSession',totalquestions='$totalQuestions',notanswered='$notAnswered', totalright='$totalTrue',totalwrong='$wrong',signtest='$signTestResult',finalresult='$finalResult' WHERE candidateid='$candidateID'"); 
...
$row= mysqli_fetch_row($fetchQuestionsQR);
                                ?>
                                <form name=myfm method=post action=examForBike.php>
                                    <table>
                                        <?php
