                   ...
                   <?php
                    ...
                    <div class="column">        
                        <table class="ui table compact">
                            <tr>
                                <td colspan="2"><h3 class="text-center"><?php echo "Fee Voucher".date("Y")."<br>".$schoolName."<br> City Traffic Police Faisalabad"?></h3></td>
                            </tr>
                            ...
                            <tr>
                                <td><h4 class=text-center>Description</h4></td>
                                <td><h4 class=text-center>Amount</h4></td>
                            </tr>
                            <tr>
                                <td>Admission Fee</td>
                                <td>3000</td>
                            ...
                            <tr>
                                <td><h4>Net Amount Payable</h4></td>
                                <td><h4>3400/-</h4></td>
                            </tr>
                            <tr>
                                <td colspan="2">
